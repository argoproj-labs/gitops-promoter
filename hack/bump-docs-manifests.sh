...
sed_replace "s/download\/v[0-9]\{1,\}\.[0-9]\{1,\}\.[0-9]\{1,\}/download\/v$NEW_VERSION/g" docs/argocd-integrations/index.md
sed_replace "s/gitops-promoter_[0-9]\{1,\}\.[0-9]\{1,\}\.[0-9]\{1,\}_checksums\.txt/gitops-promoter_${NEW_VERSION}_checksums.txt/g" docs/argocd-integrations/index.md
...
sed_replace "s|gitops-promoter/releases/download/v[0-9]\{1,\}\.[0-9]\{1,\}\.[0-9]\{1,\}/install-without-ui.yaml|gitops-promoter/releases/download/v$NEW_VERSION/install-without-ui.yaml|g" cmd/demo/config/config.yaml
