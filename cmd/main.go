...
func main() {
	...
	flag.StringVar(&promotionStrategyRequeue, "promotion-strategy-requeue-duration", "60s", "How frequently to requeue promotion strategy resources for auto reconciliation")
	flag.StringVar(&proposedCommitRequeue, "proposed-commit-requeue-duration", "60s", "How frequently to requeue proposed commit resources for auto reconciliation")
	opts := zap.Options{
		Development: true,
