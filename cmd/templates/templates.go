...
// MockResponseFile is the on-disk shape of the `--response` and `--response-updated` inputs:
// a YAML object with statusCode, body (any, typically a JSON-compatible scalar/map/slice or a string),
