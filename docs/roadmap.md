...
- **[Verified GitHub webhook signatures](https://github.com/argoproj-labs/gitops-promoter/issues/1285)** — Validate inbound webhooks using `webhookSecret` / `webhookSignatureHeader` on the Provider secret (HMAC-SHA256 or shared token).
