...
```bash
kubectl apply -f https://github.com/argoproj-labs/gitops-promoter/releases/download/v0.42.1/install-with-dashboard-cert-manager.yaml
```
...
```bash
kubectl apply -f https://github.com/argoproj-labs/gitops-promoter/releases/download/v0.42.1/install-with-dashboard-byo-cert.yaml
```
...
```bash
kubectl apply -f https://github.com/argoproj-labs/gitops-promoter/releases/download/v0.42.1/install-without-ui.yaml
```
