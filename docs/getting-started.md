...
```bash
kubectl apply -f https://github.com/argoproj-labs/gitops-promoter/releases/download/v0.40.0/install-with-dashboard-cert-manager.yaml
```
...
```bash
kubectl apply -f https://github.com/argoproj-labs/gitops-promoter/releases/download/v0.40.0/install-with-dashboard-byo-cert.yaml
```
...
```bash
kubectl apply -f https://github.com/argoproj-labs/gitops-promoter/releases/download/v0.40.0/install-without-ui.yaml
```
