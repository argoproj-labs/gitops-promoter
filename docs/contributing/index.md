...
- **Status writes** — Status subresource updates go through the deferred `utils.HandleReconciliationResult` using per-controller SSA; see [Updating status](updating-status.md).
