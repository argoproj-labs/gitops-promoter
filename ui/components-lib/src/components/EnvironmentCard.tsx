          ...
          prCard = (
            <PrCard
              ...
              commit={{
                ...
                hydratedCommitAuthor: env.hydratedCommitAuthor,
                hydratedCommitSubject: env.hydratedCommitSubject,
                hydratedCommitBody: env.hydratedCommitBody,
                hydratedCommitUrl: env.hydratedCommitUrl,
                hydratedCommitDate: env.hydratedCommitDate,
                branch: env.branch,
                link: env.hydratedCommitUrl,
                author: env.hydratedCommitAuthor,
                message: env.hydratedCommitSubject,
                body: env.hydratedCommitBody,
