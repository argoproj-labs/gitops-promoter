...
function getEnvDetails(environment: Environment, index: number = 0): EnrichedEnvDetails {
  ...
  return {
    ...
    activeReferenceCommitUrl: activeReferenceData ? getCommitUrl(activeReferenceData.url ?? '', activeReferenceData.sha ?? '') : null,
    ...
    proposedReferenceCommitUrl: proposedReferenceData ? getCommitUrl(proposedReferenceData.url ?? '', proposedReferenceData.sha ?? '') : null,
    proposedChecks,
