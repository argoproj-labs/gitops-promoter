...
export type components = {
    schemas: {
        ...
        ScmProviderSpec: {
            ...
            /** @description InboundWebhookVerification controls signature verification for inbound SCM webhooks delivered to the promoter webhook receiver for GitRepositories using this provider. RequireVerification needs ScmProviderSecretKeyWebhookSecret on the Provider secret referenced by secretRef. */
        ...
        /** @description WebhookModeSpec configures inbound webhook acceleration for WebRequestCommitStatus. Authentication secrets live on the Provider secret referenced by the GitRepository; this block only controls optional payload filtering before enqueue. */
        WebhookModeSpec: {
