...
// It records every Execute call as a RenderedRequest snapshot, exposed via Rendered().
//
...
func (e *mockHTTPEXecutor) Execute(_ context.Context, wrcs *promoterv1alpha1.WebRequestCommitStatus, td webrequest.TemplateData) (webrequest.HTTPResponse, error) {
	...
	e.rendered = append(e.rendered, simulatortypes.RenderedRequest{
...
// Rendered returns the rendered HTTP request snapshots accumulated across Execute calls.
func (e *mockHTTPEXecutor) Rendered() []simulatortypes.RenderedRequest {
	return e.rendered
}
