...
// (each entry: Branch for routing in environments context, plus Response with
// StatusCode/Body/Headers; promotionstrategy uses only index 0); the simulator returns the rendered HTTP request,
