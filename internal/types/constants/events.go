...
const (
	...
	// MissingProposedDryMetadataReason indicates that the proposed branch has hydration output but
	// promoter could not read a dry SHA from hydrator.metadata at activePath.
	MissingProposedDryMetadataReason = "MissingProposedDryMetadata"
	// MissingProposedDryMetadataMessage is the message for missing proposed dry metadata.
	MissingProposedDryMetadataMessage = "Proposed branch %q has hydrated commit %s but no dry SHA from %q"
