...
func (_m *MockPullRequestProvider) FindOpen(ctx context.Context, pullRequest v1alpha1.PullRequest) (bool, string, time.Time, error) {
	ret := _m.Called(ctx, pullRequest)
	...
	var r2 time.Time
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, v1alpha1.PullRequest) (bool, string, time.Time, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, v1alpha1.PullRequest) string); ok {
		r1 = rf(ctx, pullRequest)
	} else {
		r1 = ret.Get(1).(string)
	}

	if rf, ok := ret.Get(2).(func(context.Context, v1alpha1.PullRequest) time.Time); ok {
		r2 = rf(ctx, pullRequest)
	} else {
		r2 = ret.Get(2).(time.Time)
	}

	if rf, ok := ret.Get(3).(func(context.Context, v1alpha1.PullRequest) error); ok {
		r3 = rf(ctx, pullRequest)
	} else {
		r3 = ret.Error(3)
	}
...
func (_c *MockPullRequestProvider_FindOpen_Call) RunAndReturn(run func(context.Context, v1alpha1.PullRequest) (bool, string, time.Time, error)) *MockPullRequestProvider_FindOpen_Call {
	_c.Call.Return(run)
	return _c
}

// GetUrl provides a mock function with given fields: ctx, pullRequest
func (_m *MockPullRequestProvider) GetUrl(ctx context.Context, pullRequest v1alpha1.PullRequest) (string, error) {
	ret := _m.Called(ctx, pullRequest)
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1alpha1.PullRequest) (string, error)); ok {
		return rf(ctx, pullRequest)
	}
	if rf, ok := ret.Get(0).(func(context.Context, v1alpha1.PullRequest) string); ok {
		r0 = rf(ctx, pullRequest)
	} else {
		r0 = ret.Get(0).(string)
	}
...
//   - ctx context.Context
//   - pullRequest v1alpha1.PullRequest
func (_e *MockPullRequestProvider_Expecter) GetUrl(ctx interface{}, pullRequest interface{}) *MockPullRequestProvider_GetUrl_Call {
...
func (_c *MockPullRequestProvider_GetUrl_Call) Return(_a0 string, _a1 error) *MockPullRequestProvider_GetUrl_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPullRequestProvider_GetUrl_Call) RunAndReturn(run func(context.Context, v1alpha1.PullRequest) (string, error)) *MockPullRequestProvider_GetUrl_Call {
	_c.Call.Return(run)
	return _c
}

// HasAutoBranchDeletionEnabled provides a mock function with given fields: ctx, pullRequest
func (_m *MockPullRequestProvider) HasAutoBranchDeletionEnabled(ctx context.Context, pullRequest v1alpha1.PullRequest) (bool, error) {
	ret := _m.Called(ctx, pullRequest)

	if len(ret) == 0 {
		panic("no return value specified for HasAutoBranchDeletionEnabled")
	}
...
// MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasAutoBranchDeletionEnabled'
type MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call struct {
	*mock.Call
}

// HasAutoBranchDeletionEnabled is a helper method to define mock.On call
//   - ctx context.Context
//   - pullRequest v1alpha1.PullRequest
func (_e *MockPullRequestProvider_Expecter) HasAutoBranchDeletionEnabled(ctx interface{}, pullRequest interface{}) *MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call {
	return &MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call{Call: _e.mock.On("HasAutoBranchDeletionEnabled", ctx, pullRequest)}
}

func (_c *MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call) Run(run func(ctx context.Context, pullRequest v1alpha1.PullRequest)) *MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(v1alpha1.PullRequest))
	})
	return _c
...
func (_c *MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call) Return(_a0 bool, _a1 error) *MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call) RunAndReturn(run func(context.Context, v1alpha1.PullRequest) (bool, error)) *MockPullRequestProvider_HasAutoBranchDeletionEnabled_Call {
	_c.Call.Return(run)
	return _c
}

// Merge provides a mock function with given fields: ctx, pullRequest
func (_m *MockPullRequestProvider) Merge(ctx context.Context, pullRequest v1alpha1.PullRequest) error {
	ret := _m.Called(ctx, pullRequest)
...
//   - ctx context.Context
//   - pullRequest v1alpha1.PullRequest
func (_e *MockPullRequestProvider_Expecter) Merge(ctx interface{}, pullRequest interface{}) *MockPullRequestProvider_Merge_Call {
...
func (_c *MockPullRequestProvider_Merge_Call) RunAndReturn(run func(context.Context, v1alpha1.PullRequest) error) *MockPullRequestProvider_Merge_Call {
	_c.Call.Return(run)
	return _c
}
