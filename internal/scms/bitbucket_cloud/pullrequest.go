...
func (pr *PullRequest) AddLabels(_ context.Context, _ v1alpha1.PullRequest, _ []string) error {
	return errors.New("merge signal delegation (AddLabels) is not supported for Bitbucket Cloud in this version")
}
...
func (pr *PullRequest) RemoveLabel(_ context.Context, _ v1alpha1.PullRequest, _ string) error {
	return errors.New("merge signal delegation (RemoveLabel) is not supported for Bitbucket Cloud in this version")
}
...
func (pr *PullRequest) CreateComment(_ context.Context, _ v1alpha1.PullRequest, _ string) (string, error) {
	return "", errors.New("merge signal delegation (CreateComment) is not supported for Bitbucket Cloud in this version")
}
...
func (pr *PullRequest) DeleteComment(_ context.Context, _ v1alpha1.PullRequest, _ string) error {
	return errors.New("merge signal delegation (DeleteComment) is not supported for Bitbucket Cloud in this version")
}
