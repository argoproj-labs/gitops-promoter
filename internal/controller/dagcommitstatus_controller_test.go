	...
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &promoterv1alpha1.DAGCommitStatus{
					ObjectMeta: metav1.ObjectMeta{
						Name:      resourceName,
						Namespace: "default",
					},
					Spec: promoterv1alpha1.DAGCommitStatusSpec{
						PromotionStrategyRef: promoterv1alpha1.ObjectReference{Name: "test-promotion-strategy"},
						Key:                  "promoter-dag",
		...
		It("should successfully reconcile the resource", func() {
			...
			controllerReconciler := &DAGCommitStatusReconciler{
				Client: k8sClient,
