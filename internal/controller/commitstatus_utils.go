...
const (
	// CommitPhaseSuccess represents a successful commit status
	CommitPhaseSuccess = "success"
	// CommitPhaseFailure represents a failed commit status
	CommitPhaseFailure = "failure"
)
...
// This is a shared utility function used by both GitCommitStatusReconciler and TimedCommitStatusReconciler.
