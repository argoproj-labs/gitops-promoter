...
var _ = Describe("TimedCommitStatus Controller", Ordered, func() {
	...
	BeforeAll(func() {
		...
		// The DAGCommitStatus generated by this PreviousEnvironmentCommitStatus produces the
		// previous-environment gate CommitStatus declared above.
		previousEnvironmentCommitStatus = &promoterv1alpha1.PreviousEnvironmentCommitStatus{
	...
	AfterAll(func() {
		...
		if previousEnvironmentCommitStatus != nil {
			_ = k8sClient.Delete(ctx, previousEnvironmentCommitStatus)
		}
