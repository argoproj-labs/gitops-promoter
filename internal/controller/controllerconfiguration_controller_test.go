					...
					Spec: promoterv1alpha1.ControllerConfigurationSpec{
						PullRequest: promoterv1alpha1.PullRequestConfiguration{
							Template: promoterv1alpha1.PullRequestTemplate{
								Title:       "Automated PR for {{.PromotionStrategy}}",
								Description: "This PR is automatically generated by GitOps Promoter for the {{.PromotionStrategy}} promotion strategy.",
							},
						},
						PromotionStrategyRequeueDuration:    metav1.Duration{Duration: time.Minute * 5},
						ChangeTransferPolicyRequeueDuration: metav1.Duration{Duration: time.Minute * 5},
						ArgoCDCommitStatusRequeueDuration:   metav1.Duration{Duration: time.Second * 15},
					},
				}
