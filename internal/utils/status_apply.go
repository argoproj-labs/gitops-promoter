...
func CommitShaStateToApply(s promoterv1alpha1.CommitShaState) *acv1alpha1.CommitShaStateApplyConfiguration {
...
func HydratorMetadataToApply(m *promoterv1alpha1.HydratorMetadata) *acv1alpha1.HydratorMetadataApplyConfiguration {
	if m == nil {
		return nil
	}
...
func CommitStatusesToApply(statuses []promoterv1alpha1.ChangeRequestPolicyCommitStatusPhase) []*acv1alpha1.ChangeRequestPolicyCommitStatusPhaseApplyConfiguration {
...
func CommitBranchStateToApply(s promoterv1alpha1.CommitBranchState) *acv1alpha1.CommitBranchStateApplyConfiguration {
...
func PullRequestCommonStatusToApply(pr *promoterv1alpha1.PullRequestCommonStatus) *acv1alpha1.PullRequestCommonStatusApplyConfiguration {
	if pr == nil {
		return nil
	}
...
func HistoryToApply(h promoterv1alpha1.History) *acv1alpha1.HistoryApplyConfiguration {
