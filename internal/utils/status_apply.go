...
func statusApplyConfig(obj client.Object, conditionsOnly bool) (any, error) {
	...
	case *promoterv1alpha1.PromotionStrategyHistory:
		return promotionStrategyHistoryStatusApply(o, conditionsOnly)
...
func promotionStrategyHistoryStatusApply(o *promoterv1alpha1.PromotionStrategyHistory, conditionsOnly bool) (any, error) {
	statusAC := acv1alpha1.PromotionStrategyHistoryStatus()
	if conditionsOnly {
		statusAC = statusAC.WithConditions(ConditionsToApply(o.Status.Conditions)...)
	} else if err := jsonRoundTrip(&o.Status, statusAC); err != nil {
		return nil, err
	}
	return acv1alpha1.PromotionStrategyHistory(o.Name, o.Namespace).WithStatus(statusAC), nil
}
