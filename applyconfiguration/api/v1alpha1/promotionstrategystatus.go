...
// PromotionStrategyStatusApplyConfiguration represents a declarative configuration of the PromotionStrategyStatus type for use
// with apply.
//
...
// PromotionStrategyStatusApplyConfiguration constructs a declarative configuration of the PromotionStrategyStatus type for use with
// apply.
...
func (b *PromotionStrategyStatusApplyConfiguration) WithEnvironments(values ...*EnvironmentStatusApplyConfiguration) *PromotionStrategyStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *PromotionStrategyStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *PromotionStrategyStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *PromotionStrategyStatusApplyConfiguration) WithInstanceID(value string) *PromotionStrategyStatusApplyConfiguration {
	b.InstanceID = &value
	return b
}
