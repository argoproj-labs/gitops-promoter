...
// DryShaValidationCommitStatusStatusApplyConfiguration represents a declarative configuration of the DryShaValidationCommitStatusStatus type for use
// with apply.
//
// DryShaValidationCommitStatusStatus defines the observed state of DryShaValidationCommitStatus.
type DryShaValidationCommitStatusStatusApplyConfiguration struct {
	...
	Environments []DryShaValidationEnvironmentStatusApplyConfiguration `json:"environments,omitempty"`
...
// DryShaValidationCommitStatusStatusApplyConfiguration constructs a declarative configuration of the DryShaValidationCommitStatusStatus type for use with
// apply.
func DryShaValidationCommitStatusStatus() *DryShaValidationCommitStatusStatusApplyConfiguration {
	return &DryShaValidationCommitStatusStatusApplyConfiguration{}
}

// WithObservedGeneration sets the ObservedGeneration field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ObservedGeneration field is set to the value of the last call.
func (b *DryShaValidationCommitStatusStatusApplyConfiguration) WithObservedGeneration(value int64) *DryShaValidationCommitStatusStatusApplyConfiguration {
...
func (b *DryShaValidationCommitStatusStatusApplyConfiguration) WithEnvironments(values ...*DryShaValidationEnvironmentStatusApplyConfiguration) *DryShaValidationCommitStatusStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *DryShaValidationCommitStatusStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *DryShaValidationCommitStatusStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *DryShaValidationCommitStatusStatusApplyConfiguration) WithInstanceID(value string) *DryShaValidationCommitStatusStatusApplyConfiguration {
	b.InstanceID = &value
	return b
}
