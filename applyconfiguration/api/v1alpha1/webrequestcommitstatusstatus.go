...
// WebRequestCommitStatusStatusApplyConfiguration represents a declarative configuration of the WebRequestCommitStatusStatus type for use
// with apply.
//
...
// WebRequestCommitStatusStatusApplyConfiguration constructs a declarative configuration of the WebRequestCommitStatusStatus type for use with
// apply.
func WebRequestCommitStatusStatus() *WebRequestCommitStatusStatusApplyConfiguration {
	return &WebRequestCommitStatusStatusApplyConfiguration{}
}
...
func (b *WebRequestCommitStatusStatusApplyConfiguration) WithEnvironments(values ...*WebRequestCommitStatusEnvironmentStatusApplyConfiguration) *WebRequestCommitStatusStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *WebRequestCommitStatusStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *WebRequestCommitStatusStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *WebRequestCommitStatusStatusApplyConfiguration) WithInstanceID(value string) *WebRequestCommitStatusStatusApplyConfiguration {
	b.InstanceID = &value
	return b
}
