...
// DryShaValidationCommitStatusConfigurationApplyConfiguration represents a declarative configuration of the DryShaValidationCommitStatusConfiguration type for use
// with apply.
//
...
type DryShaValidationCommitStatusConfigurationApplyConfiguration struct {
...
// DryShaValidationCommitStatusConfigurationApplyConfiguration constructs a declarative configuration of the DryShaValidationCommitStatusConfiguration type for use with
// apply.
func DryShaValidationCommitStatusConfiguration() *DryShaValidationCommitStatusConfigurationApplyConfiguration {
	return &DryShaValidationCommitStatusConfigurationApplyConfiguration{}
}
...
func (b *DryShaValidationCommitStatusConfigurationApplyConfiguration) WithWorkQueue(value *WorkQueueApplyConfiguration) *DryShaValidationCommitStatusConfigurationApplyConfiguration {
	b.WorkQueue = value
	return b
}
