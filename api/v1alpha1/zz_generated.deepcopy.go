...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArgoCDCommitStatusControllerStatus) DeepCopyInto(out *ArgoCDCommitStatusControllerStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArgoCDCommitStatusControllerStatus.
func (in *ArgoCDCommitStatusControllerStatus) DeepCopy() *ArgoCDCommitStatusControllerStatus {
	if in == nil {
		return nil
	}
	out := new(ArgoCDCommitStatusControllerStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ControllerConfigurationStatus) DeepCopyInto(out *ControllerConfigurationStatus) {
	*out = *in
	out.ArgoCDCommitStatus = in.ArgoCDCommitStatus
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
		for i := range *in {
