...
func (in *ChangeTransferPolicySpec) DeepCopyInto(out *ChangeTransferPolicySpec) {
	*out = *in
	...
	if in.OpenPullerRequestFilter != nil {
		...
		*out = new(OpenPullerRequestFilter)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenPullerRequestFilter) DeepCopyInto(out *OpenPullerRequestFilter) {
	*out = *in
	if in.Paths != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenPullerRequestFilter.
func (in *OpenPullerRequestFilter) DeepCopy() *OpenPullerRequestFilter {
	if in == nil {
		return nil
	}
	out := new(OpenPullerRequestFilter)
