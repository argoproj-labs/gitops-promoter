...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreviousEnvEnvironment) DeepCopyInto(out *PreviousEnvEnvironment) {
	*out = *in
	if in.ActiveCommitStatuses != nil {
		in, out := &in.ActiveCommitStatuses, &out.ActiveCommitStatuses
		*out = make([]CommitStatusSelector, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreviousEnvEnvironment.
func (in *PreviousEnvEnvironment) DeepCopy() *PreviousEnvEnvironment {
	if in == nil {
		return nil
	}
	out := new(PreviousEnvEnvironment)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PreviousEnvEnvironmentStatus) DeepCopyInto(out *PreviousEnvEnvironmentStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PreviousEnvEnvironmentStatus.
func (in *PreviousEnvEnvironmentStatus) DeepCopy() *PreviousEnvEnvironmentStatus {
	if in == nil {
		return nil
	}
	out := new(PreviousEnvEnvironmentStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PreviousEnvironmentCommitStatusSpec) DeepCopyInto(out *PreviousEnvironmentCommitStatusSpec) {
	*out = *in
	...
	if in.Environments != nil {
		in, out := &in.Environments, &out.Environments
		*out = make([]PreviousEnvEnvironment, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PreviousEnvironmentCommitStatusStatus) DeepCopyInto(out *PreviousEnvironmentCommitStatusStatus) {
	*out = *in
	if in.Environments != nil {
		in, out := &in.Environments, &out.Environments
		*out = make([]PreviousEnvEnvironmentStatus, len(*in))
		copy(*out, *in)
	}
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
