...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommitBranchStateProposedHistory) DeepCopyInto(out *CommitBranchStateProposedHistory) {
	*out = *in
	if in.CommitStatuses != nil {
		in, out := &in.CommitStatuses, &out.CommitStatuses
		*out = make([]ChangeRequestPolicyCommitStatusPhase, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommitBranchStateProposedHistory.
func (in *CommitBranchStateProposedHistory) DeepCopy() *CommitBranchStateProposedHistory {
	if in == nil {
		return nil
	}
	out := new(CommitBranchStateProposedHistory)
	in.DeepCopyInto(out)
	return out
}
