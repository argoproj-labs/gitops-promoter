...
func (in *CommitBranchState) DeepCopyInto(out *CommitBranchState) {
	*out = *in
	...
	if in.CommitStatuses != nil {
		...
		*out = make([]ProposedCommitCommitStatusPhase, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProposedCommitCommitStatusPhase) DeepCopyInto(out *ProposedCommitCommitStatusPhase) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProposedCommitCommitStatusPhase.
func (in *ProposedCommitCommitStatusPhase) DeepCopy() *ProposedCommitCommitStatusPhase {
	if in == nil {
		return nil
	}
	out := new(ProposedCommitCommitStatusPhase)
	in.DeepCopyInto(out)
	return out
}
