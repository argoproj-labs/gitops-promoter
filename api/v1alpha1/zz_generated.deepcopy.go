...
func (in *CommitBranchState) DeepCopyInto(out *CommitBranchState) {
	*out = *in
	...
	if in.CommitStatuses != nil {
		...
		*out = make([]ProposedCommitCommitStatusState, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProposedCommitCommitStatusState) DeepCopyInto(out *ProposedCommitCommitStatusState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProposedCommitCommitStatusState.
func (in *ProposedCommitCommitStatusState) DeepCopy() *ProposedCommitCommitStatusState {
	if in == nil {
		return nil
	}
	out := new(ProposedCommitCommitStatusState)
	in.DeepCopyInto(out)
	return out
}
