...
func (in *ArgoCDCommitStatusStatus) DeepCopyInto(out *ArgoCDCommitStatusStatus) {
	*out = *in
	if in.ApplicationsSelected != nil {
		...
		*out = make([]SelectedApplications, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SelectedApplications) DeepCopyInto(out *SelectedApplications) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SelectedApplications.
func (in *SelectedApplications) DeepCopy() *SelectedApplications {
	if in == nil {
		return nil
	}
	out := new(SelectedApplications)
	in.DeepCopyInto(out)
	return out
}
