...
func (in *AggregatedCommitStatus) DeepCopyInto(out *AggregatedCommitStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AggregatedCommitStatus.
func (in *AggregatedCommitStatus) DeepCopy() *AggregatedCommitStatus {
	if in == nil {
		return nil
	}
	out := new(AggregatedCommitStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ChangeTransferPolicyCommitStatusPhase) DeepCopyInto(out *ChangeTransferPolicyCommitStatusPhase) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ChangeTransferPolicyCommitStatusPhase.
func (in *ChangeTransferPolicyCommitStatusPhase) DeepCopy() *ChangeTransferPolicyCommitStatusPhase {
	if in == nil {
		return nil
	}
	out := new(ChangeTransferPolicyCommitStatusPhase)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CommitBranchState) DeepCopyInto(out *CommitBranchState) {
	*out = *in
	...
	if in.CommitStatuses != nil {
		...
		*out = make([]ChangeTransferPolicyCommitStatusPhase, len(*in))
		copy(*out, *in)
	}
}
...
func (in *PromotionStrategyBranchStateStatus) DeepCopyInto(out *PromotionStrategyBranchStateStatus) {
	*out = *in
	in.Dry.DeepCopyInto(&out.Dry)
	in.Hydrated.DeepCopyInto(&out.Hydrated)
	out.AggregatedCommitStatus = in.AggregatedCommitStatus
	if in.CommitStatuses != nil {
		in, out := &in.CommitStatuses, &out.CommitStatuses
		*out = make([]ChangeTransferPolicyCommitStatusPhase, len(*in))
		copy(*out, *in)
