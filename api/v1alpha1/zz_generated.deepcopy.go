...
func (in *CommitBranchState) DeepCopyInto(out *CommitBranchState) {
	*out = *in
	...
	if in.CommitMetadata != nil {
		in, out := &in.CommitMetadata, &out.CommitMetadata
		*out = new(HydratorMetadataFile)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HydratorMetadataFile) DeepCopyInto(out *HydratorMetadataFile) {
	*out = *in
	if in.Commands != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HydratorMetadataFile.
func (in *HydratorMetadataFile) DeepCopy() *HydratorMetadataFile {
	if in == nil {
		return nil
	}
	out := new(HydratorMetadataFile)
