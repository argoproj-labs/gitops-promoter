...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnvironmentTimeCommitStatus) DeepCopyInto(out *EnvironmentTimeCommitStatus) {
	*out = *in
	out.Duration = in.Duration
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvironmentTimeCommitStatus.
func (in *EnvironmentTimeCommitStatus) DeepCopy() *EnvironmentTimeCommitStatus {
	if in == nil {
		return nil
	}
	out := new(EnvironmentTimeCommitStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnvironmentTimedStatus) DeepCopyInto(out *EnvironmentTimedStatus) {
	*out = *in
	in.CommitTime.DeepCopyInto(&out.CommitTime)
	out.RequiredDuration = in.RequiredDuration
	out.TimeElapsed = in.TimeElapsed
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnvironmentTimedStatus.
func (in *EnvironmentTimedStatus) DeepCopy() *EnvironmentTimedStatus {
	if in == nil {
		return nil
	}
	out := new(EnvironmentTimedStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TimedCommitStatusSpec) DeepCopyInto(out *TimedCommitStatusSpec) {
	*out = *in
	...
	if in.Environments != nil {
		in, out := &in.Environments, &out.Environments
		*out = make([]EnvironmentTimeCommitStatus, len(*in))
		copy(*out, *in)
	}
}
...
func (in *TimedCommitStatusStatus) DeepCopyInto(out *TimedCommitStatusStatus) {
	*out = *in
	if in.Environments != nil {
		in, out := &in.Environments, &out.Environments
		*out = make([]EnvironmentTimedStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
