...
func (in *ChangeTransferPolicySpec) DeepCopyInto(out *ChangeTransferPolicySpec) {
	*out = *in
	...
	if in.MergeComments != nil {
		in, out := &in.MergeComments, &out.MergeComments
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MergeSignals) DeepCopyInto(out *MergeSignals) {
	*out = *in
	if in.Comments != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MergeSignals.
func (in *MergeSignals) DeepCopy() *MergeSignals {
	if in == nil {
		return nil
	}
	out := new(MergeSignals)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PullRequestSpec) DeepCopyInto(out *PullRequestSpec) {
	*out = *in
	...
	if in.PendingMergeSignals != nil {
		in, out := &in.PendingMergeSignals, &out.PendingMergeSignals
		*out = new(MergeSignals)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *PullRequestStatus) DeepCopyInto(out *PullRequestStatus) {
	*out = *in
	...
	if in.PostedMergeCommentIDs != nil {
		in, out := &in.PostedMergeCommentIDs, &out.PostedMergeCommentIDs
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.AppliedMergeLabels != nil {
		in, out := &in.AppliedMergeLabels, &out.AppliedMergeLabels
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Conditions != nil {
