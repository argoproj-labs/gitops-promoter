...
func (in *ChangeTransferPolicyStatus) DeepCopyInto(out *ChangeTransferPolicyStatus) {
	*out = *in
	...
	in.DoraMetrics.DeepCopyInto(&out.DoraMetrics)
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DoraMetricsState) DeepCopyInto(out *DoraMetricsState) {
	*out = *in
	in.LeadTimeStartCommitTime.DeepCopyInto(&out.LeadTimeStartCommitTime)
	in.FailureStartTime.DeepCopyInto(&out.FailureStartTime)
	if in.LastLeadTimeSeconds != nil {
		in, out := &in.LastLeadTimeSeconds, &out.LastLeadTimeSeconds
		*out = new(v1.Duration)
		**out = **in
	}
	if in.LastMTTRSeconds != nil {
		in, out := &in.LastMTTRSeconds, &out.LastMTTRSeconds
		*out = new(v1.Duration)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DoraMetricsState.
func (in *DoraMetricsState) DeepCopy() *DoraMetricsState {
	if in == nil {
		return nil
	}
	out := new(DoraMetricsState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PromotionStrategyStatus) DeepCopyInto(out *PromotionStrategyStatus) {
	*out = *in
	...
	if in.TerminalEnvironmentDoraMetrics != nil {
		in, out := &in.TerminalEnvironmentDoraMetrics, &out.TerminalEnvironmentDoraMetrics
		*out = new(DoraMetricsState)
		(*in).DeepCopyInto(*out)
	}
	if in.Conditions != nil {
