...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScmAuth) DeepCopyInto(out *ScmAuth) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScmAuth.
func (in *ScmAuth) DeepCopy() *ScmAuth {
	if in == nil {
		return nil
	}
	out := new(ScmAuth)
