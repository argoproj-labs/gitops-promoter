...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CommitStatusProposedCommitStatusState) DeepCopyInto(out *CommitStatusProposedCommitStatusState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CommitStatusProposedCommitStatusState.
func (in *CommitStatusProposedCommitStatusState) DeepCopy() *CommitStatusProposedCommitStatusState {
	if in == nil {
		return nil
	}
	out := new(CommitStatusProposedCommitStatusState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProposedCommitShaState) DeepCopyInto(out *ProposedCommitShaState) {
	*out = *in
	...
	if in.ActiveCommitStatuses != nil {
		in, out := &in.ActiveCommitStatuses, &out.ActiveCommitStatuses
		*out = make([]CommitStatusProposedCommitStatusState, len(*in))
		copy(*out, *in)
	}
	if in.ProposedCommitStatuses != nil {
		in, out := &in.ProposedCommitStatuses, &out.ProposedCommitStatuses
