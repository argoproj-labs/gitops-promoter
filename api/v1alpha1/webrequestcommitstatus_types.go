...
type ModeSpec struct {
	...
	// ScmProvider; signing material is webhookSecret on the Provider secret when
...
// Authentication secrets live on the Provider secret referenced by the GitRepository;
