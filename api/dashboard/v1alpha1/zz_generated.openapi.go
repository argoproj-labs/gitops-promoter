...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.EnvironmentRollup":            schema_gitops_promoter_api_dashboard_v1alpha1_EnvironmentRollup(ref),
		"github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.GateSummary":                  schema_gitops_promoter_api_dashboard_v1alpha1_GateSummary(ref),
...
func schema_gitops_promoter_api_dashboard_v1alpha1_EnvironmentRollup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EnvironmentRollup is a server-computed summary of a single environment in the promotion sequence, joining the PromotionStrategy environment status with its owning ChangeTransferPolicy and gate statuses.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"branch": {
						SchemaProps: spec.SchemaProps{
							Description: "Branch is the active branch name for the environment.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"changeTransferPolicyName": {
						SchemaProps: spec.SchemaProps{
							Description: "ChangeTransferPolicyName is the name of the CTP that owns this environment, if known.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"active": {
						SchemaProps: spec.SchemaProps{
							Description: "Active is the state of the active branch for this environment.",
					...
					"proposed": {
						SchemaProps: spec.SchemaProps{
							Description: "Proposed is the state of the proposed branch for this environment.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/argoproj-labs/gitops-promoter/api/v1alpha1.CommitBranchState"),
						},
					},
					"activeGates": {
						SchemaProps: spec.SchemaProps{
							Description: "ActiveGates summarizes the active commit-status gates for this environment.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.GateSummary"),
						},
					},
					"proposedGates": {
						SchemaProps: spec.SchemaProps{
							Description: "ProposedGates summarizes the proposed commit-status gates for this environment.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.GateSummary"),
						},
					},
					"pullRequest": {
						SchemaProps: spec.SchemaProps{
							Description: "PullRequest is the state of the pull request for this environment, if any.",
							Ref:         ref("github.com/argoproj-labs/gitops-promoter/api/v1alpha1.PullRequestCommonStatus"),
						},
					},
					"promoted": {
						SchemaProps: spec.SchemaProps{
							Description: "Promoted is true when the proposed dry SHA matches the active dry SHA, i.e. the latest change has been promoted into this environment.",
							Default:     false,
							Type:        []string{"boolean"},
							Format:      "",
						},
				...
				Required: []string{"branch", "promoted"},
			},
		},
		Dependencies: []string{
			"github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.GateSummary", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.CommitBranchState", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.PullRequestCommonStatus"},
	}
}

func schema_gitops_promoter_api_dashboard_v1alpha1_GateSummary(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "GateSummary summarizes the phases of a set of commit-status gates.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"total": {
						SchemaProps: spec.SchemaProps{
							Description: "Total is the number of gates considered.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"pending": {
						SchemaProps: spec.SchemaProps{
							Description: "Pending is the number of gates in the pending phase.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"success": {
						SchemaProps: spec.SchemaProps{
							Description: "Success is the number of gates in the success phase.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"failure": {
						SchemaProps: spec.SchemaProps{
							Description: "Failure is the number of gates in the failure phase.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
				...
				Required: []string{"total", "pending", "success", "failure"},
			},
		},
	}
}
...
func schema_gitops_promoter_api_dashboard_v1alpha1_PromotionStrategyDetails(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"environments": {
						SchemaProps: spec.SchemaProps{
							Description: "Environments is a server-computed per-environment rollup, in the order declared by the PromotionStrategy spec.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.EnvironmentRollup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.EnvironmentRollup", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.ArgoCDCommitStatus", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.ChangeTransferPolicy", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.ClusterScmProvider", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.CommitStatus", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.GitCommitStatus", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.GitRepository", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.PromotionStrategy", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.PullRequest", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.ScmProvider", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.TimedCommitStatus", "github.com/argoproj-labs/gitops-promoter/api/v1alpha1.WebRequestCommitStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_gitops_promoter_api_dashboard_v1alpha1_PromotionStrategyDetailsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/argoproj-labs/gitops-promoter/api/dashboard/v1alpha1.PromotionStrategyDetails", v1.ListMeta{}.OpenAPIModelName()},
	}
}
